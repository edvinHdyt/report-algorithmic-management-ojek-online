...
### 1.2.1 Suspend Otomatis dan Minimnya Ruang Banding (Lensa *People*)
...
### 1.2.2 *Dynamic Pricing* yang Tidak Transparan (Lensa *Profit*)
...
### 1.2.3 Tekanan *Rating* (Lensa *Profit* & *People*)
...
### 1.2.4 Dampak Turunan terhadap Lingkungan dan Celah Status Kemitraan (Lensa *Planet* & *Profit*)
...
1. Menganalisis dampak etis dari manajemen algoritma terhadap mitra pengemudi menggunakan kerangka Triple Bottom Line.
2. Mengevaluasi kesesuaian praktik manajemen platform dengan Kode Etik Profesi TI IEEE serta hukum nasional di Indonesia.
3. Merumuskan rekomendasi solusi teknis dan etis, seperti penerapan konsep human-in-the-loop, untuk memastikan pengembangan teknologi tetap menjunjung tinggi martabat manusia.
